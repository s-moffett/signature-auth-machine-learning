...
def train_neural_network():
  ...
  with open('./Task2/Data/Results/neural_network_results.txt', 'w') as f:
    f.write('')
  ...
  for user in range(1, 41):
    ...
    with open('./Task2/Data/Results/neural_network_results.txt', 'a') as f:
...
def train_logistic_regression():
  ...
  # Overwrite any existing results file.
  with open('./Task2/Data/Results/logistic_regression_results.txt', 'w') as f:
    f.write('')
